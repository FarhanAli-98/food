...
export declare class CatalogApi extends BaseApi {
     ...
     * @return Response from the API call
     */
    listCatalog(cursor?: string, types?: string, catalogVersion?: number, requestOptions?: RequestOptions): Promise<ApiResponse<ListCatalogResponse>>;
    /**
     ...
     * @return Response from the API call
     */
    retrieveCatalogObject(objectId: string, includeRelatedObjects?: boolean, catalogVersion?: number, requestOptions?: RequestOptions): Promise<ApiResponse<RetrieveCatalogObjectResponse>>;
    /**
