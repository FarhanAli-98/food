...
import { V1BankAccount } from '../models/v1BankAccount';
...
export declare class V1TransactionsApi extends BaseApi {
     ...
     * @deprecated
     */
    listBankAccounts(locationId: string, requestOptions?: RequestOptions): Promise<ApiResponse<V1BankAccount[]>>;
    /**
     ...
     * @deprecated
     */
    retrieveBankAccount(locationId: string, bankAccountId: string, requestOptions?: RequestOptions): Promise<ApiResponse<V1BankAccount>>;
    /**
