...
export interface SchemaContextCreator extends SchemaContext {
    ...
    flatmapChildren<K extends string | number, T, S extends Schema<any, any>, R>(items: [K, T][], itemSchema: S, mapper: (item: [K, T], childCtxt: SchemaContextCreator) => R[]): R[];
    mapChildren<K extends string | number, T, S extends Schema<any, any>, R>(items: [K, T][], itemSchema: S, mapper: (item: [K, T], childCtxt: SchemaContextCreator) => R): R[];
